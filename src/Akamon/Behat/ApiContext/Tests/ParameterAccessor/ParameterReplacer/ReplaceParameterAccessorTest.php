...
namespace Akamon\Behat\ApiContext\Tests\ParameterAccessor\ParameterReplacer;

use Akamon\Behat\ApiContext\ParameterAccessor\ReplaceParameterAccessor;
...
class ReplaceParameterAccessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->delegate = \Mockery::mock('Akamon\\Behat\\ApiContext\\ParameterAccessor\\ParameterAccessorInterface');
        $this->parameterReplacer = \Mockery::mock('Akamon\\Behat\\ApiContext\\ParameterAccessor\\ParameterReplacer\\ParameterReplacerInterface');
